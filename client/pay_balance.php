...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['pay'])) {
        ...
        $request = [
            ...
            'redirect_url' => 'https://sostechmakers.com/smart-tap/client/process_payment.php',
            'customer' => [
                'email' => $email,
                'name' => $name
            ],
            ...
            'customizations' => [
                ...
                'description' => 'Payment for Water services'
            ]
        ];
...
<?= $template->dashboard_header_template('Pay Balance', $_SESSION['name'], $_SESSION['role']) ?>
<div class="container content-view mt-5 mb-5">
    ...
    <div class="wrapper d-flex justify-content-center flex-column px-md-5 px-1">
        <form class="register-form" action="pay_balance.php?id=<?= $user['id'] ?>" method="post">
            <div class="h3 text-center font-weight-bold">Pay Balance</div>
            <div class="row my-4">
                <div class="col-md-6">
            ...
            <div class="row my-md-4 my-2">
                ...
                <div class="col-md-6 pt-md-0 pt-4">
                    <label>Payment</label>
                    <input class="input100" type="number" name="payment" autocomplete="off" disabled value="<?= $user['balance'] ?>">
                    <input class="input100" hidden="hidden" type="number" name="payment" autocomplete="off" value="<?= $user['balance'] ?>">
                </div>
            </div>
