...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['pay'])) {
        ...
        $request = [
            ...
            'amount' => $payment,
            'currency' => 'UGX',
            'payment_options' => 'mobile_money_uagnda,card',
...
<?= $template->dashboard_header_template('Prepaid Payment', $_SESSION['name'], $_SESSION['role']) ?>
<div class="container content-view mt-5 mb-5">
    ...
    <div class="wrapper d-flex justify-content-center flex-column px-md-5 px-1">
        <form class="register-form" action="prepaid_payment.php?id=<?= $user['id'] ?>" method="post">
            <div class="h3 text-center font-weight-bold">Make Payment</div>
            <div class="row my-4">
                <div class="col-md-6">
